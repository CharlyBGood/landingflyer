...
export default function Navbar() {
  return (
    <nav
      className="fixed top-0 left-0 right-0 w-full z-50 grid grid-cols-3 items-center p-3 sm:p-4 lg:p-6 min-h-[3.5rem] sm:min-h-[4rem] lg:min-h-[4.5rem] text-sinapsia-light bg-[linear-gradient(135deg,_#0c070f_0%,_#150a1a_50%,_#1a0f20_100%)] animate-[slideDown_0.3s_ease-out]"
    >
      <p
      ...
      >
        <img
          ...
          className="w-[8vw] max-w-[2rem] min-w-[1.75rem] sm:w-[2.5rem] lg:w-[3rem] h-auto transition duration-200 hover:brightness-110"
        />
      </a>
    </nav>
  )
