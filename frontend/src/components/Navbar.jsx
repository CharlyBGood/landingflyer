...
export default function Navbar() {
  return (
    <nav className="navbar fixed top-0 left-0 right-0 w-full z-50 grid grid-cols-3 items-center p-3 sm:p-4 lg:p-6 min-h-14 sm:min-h-16 lg:min-h-18" style={{ color: '#c8b8d8' }}>
      <a
